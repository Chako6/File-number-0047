            ...
            <div className="flex justify-center md:justify-start gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-8 h-8 border border-white/20 flex items-center justify-center text-white/55 hover:text-gold hover:border-gold transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
